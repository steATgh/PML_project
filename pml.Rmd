...
confusionMatrix(data =  prediction , reference = dataTrain$classe )
```

Accuracy of >95% seems resonably good. 

## 6. Classification Model - Prediction  
 

```{r}
prediction_test <- round(predict(modelFit, newdata=dataTest))
prediction_test
```

However, the result with the test data looks rather suspicions. 
